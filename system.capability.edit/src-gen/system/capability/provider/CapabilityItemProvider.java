...
/**
 * This is the item provider adapter for a {@link system.capability.Capability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Capability_includes_feature",
								"_UI_Capability_type"),
						CapabilityPackage.Literals.CAPABILITY__INCLUDES, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Capability_isIncludedIn_feature",
								"_UI_Capability_type"),
						CapabilityPackage.Literals.CAPABILITY__IS_INCLUDED_IN, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Capability_extends_feature",
								"_UI_Capability_type"),
						CapabilityPackage.Literals.CAPABILITY__EXTENDS, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Capability_isExtendedBy_feature",
								"_UI_Capability_type"),
						CapabilityPackage.Literals.CAPABILITY__IS_EXTENDED_BY, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Capability_involves_feature",
								"_UI_Capability_type"),
						CapabilityPackage.Literals.CAPABILITY__INVOLVES, true, false, true, null, null, null));
	}
