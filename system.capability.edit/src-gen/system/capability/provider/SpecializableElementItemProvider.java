/**
 */
package system.capability.provider;
...
/**
 * This is the item provider adapter for a {@link system.capability.SpecializableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpecializableElementItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public SpecializableElementItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_SpecializableElement_name_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_SpecializableElement_name_feature",
						"_UI_SpecializableElement_type"),
				CapabilityPackage.Literals.SPECIALIZABLE_ELEMENT__NAME, true, false, false,
	...
	protected void addSpecializesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_SpecializableElement_specializes_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_SpecializableElement_specializes_feature",
						"_UI_SpecializableElement_type"),
				CapabilityPackage.Literals.SPECIALIZABLE_ELEMENT__SPECIALIZES, true, false, true, null, null, null));
	}
	...
	protected void addIsSpecializedByPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						CapabilityPackage.Literals.SPECIALIZABLE_ELEMENT__IS_SPECIALIZED_BY, true, false, true, null,
						null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SpecializableElement"));
	}
	...
	public ResourceLocator getResourceLocator() {
		return CapabilityEditPlugin.INSTANCE;
	}
